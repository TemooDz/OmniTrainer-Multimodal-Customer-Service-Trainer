...
class TestTextModerationResult:
    ...
    def test_boolean_fields_have_default_false(self):
...
class TestAudioModerationResult:
    ...
    def test_transcription_is_required_boolean_fields_have_defaults(self):
        """Verify transcription is required and boolean fields default to False"""
